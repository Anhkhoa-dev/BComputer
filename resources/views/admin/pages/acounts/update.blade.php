                ...
                <div class="card-body d-flex justify-content-between">
                    ...
                    <div style="width: 48%">
                        ...
                        <div class="mb-3 form-select" multiple aria-label="description">
                            ...
                            <input type="text" class="form-control bg-light text-dark" id="fullname" name="fullname"
                                value="{{ $account->fullname }}" {{ $account->level == 2 ? '' : 'disabled' }}>
                            @error('fullname')
                        ...
                        <div class="mb-3 form-select" multiple aria-label="description">
                            ...
                            <input type="date" class="form-control bg-light text-dark" id="birthday" name="birthday"
                                value="{{ $account->birthday }}" {{ $account->level == 2 ? '' : 'disabled' }}>
                            @error('birthday')
                                <span class="errorMsg">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 form-select" multiple aria-label="description">
                            ...
                            <input type="text" class="form-control bg-light text-dark" id="phone" name="phone"
                                value="{{ $account->phone }}" {{ $account->level == 2 ? '' : 'disabled' }}>
                            @error('phone')
                                <span class="errorMsg">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 form-select" multiple aria-label="description">
                            ...
                            <input type="text" class="form-control bg-light text-dark" id="email" name="email"
                                value="{{ $account->email }}" {{ $account->level == 2 ? '' : 'disabled' }}>
                            @error('email')
                                <span class="errorMsg">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div style="width: 48%">
                        ...
                        <div class="mb-3 form-select" multiple aria-label="">
                            ...
                            <input type="text" class="form-control bg-light text-dark" id="level" name="level"
                                value="{{ $account->level == 2 ? 'Admin' : 'User' }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
