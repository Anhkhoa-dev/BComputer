        ...
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#create_acount">Create</button>
                            ...
                            <tr class="align-items-center">
                                ...
                                <td>
                                    <p class="btn {{ $item->status == 1 ? 'btn-success' : 'btn-secondary' }} btn-sm">
                                        {{ $item->status == 1 ? 'Actived' : 'Clocked' }}</p>
                                </td>
                                <td class="project-actions text-right">
                                    <a class="btn btn-primary btn-sm" href="#">
                                        <i class="fas fa-folder">
                        ...
                        <center>
                            <div class="mb-3">
                                ...
                                <div class="form-group">
                                    <img id="imgPre" width="15%" src="{{ asset('image/user/avatar-default.png') }}"
                                        alt="no img" class="img-thumbnail" />
                                </div>
                                <input style="margin-left:220px; margin-top:18px;display:none" type="file"
                                    name="anhdaidien" id="ful" />
