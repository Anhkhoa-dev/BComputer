...
@section('title')
    Create Voucher | Admin BComputer
@endsection
                    ...
                    <div class="modal-body d-flex justify-content-between">
                        ...
                        <div style="width: 48%">
                            ...
                            <div class="mb-3 form-select" multiple aria-label="description">
                                ...
                                <input type="text" class="form-control" id="code" name="vou_code" placeholder="Code"
                                    value="{{ old('vou_code') }}">
                                @error('vou_code')
                            ...
                            <div class="mb-3 form-select" multiple aria-label="description">
                                ...
                                <input type="number" step="0.1" class="form-control" id="Discount" name="vou_discount"
                                    placeholder="Please input the number percent" value="{{ old('vou_discount') }}">
                                @error('vou_discount')
                                    <span class="errorMsg">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div style="width: 48%">
                            ...
                            <div class="mb-3 form-select" multiple aria-label="description">
                                ...
                                <input type="number" class="form-control" id="quanity" name="vou_quanity"
                                    placeholder="Please input the number" value="{{ old('vou_quanity') }}">
                                @error('vou_quanity')
                                    <span class="errorMsg">{{ $message }}</span>
                                @enderror
                            </div>
