    ...
    <div class="han-payment-policy">
        <div class="col-md-12">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-7 info-transfer-payment">
                        <div class="row form-color">
                            <h1>Payment by bank transfer</h1>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9 bank-text">
                                ...
                                <br>
                                Branch: Đông Sài Gòn - PGD: Quận 10
                                <br>
            ...
            <div class="col-md-10 pay-direct">
                <div class="col-md-12">
                    <h1>Direct payment at Showroom</h1>
                    <h4>Pay directly in cash, Credit card payment at Showroom</h4>
                </div>
                <div class="pay-direct">
                    <div class="row form-color">
                        ...
                        <div class="col-lg-5 address-showroom">
                            ...
                            <div>
                                <h5>Showroom CMT8 - HCM</h5>
                                <h6>590 Cach Mang Thang Tam Discrit 3, TP.HCM</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 pay-ondelivery">
                <div class="pay-ondelivery-form">
                    <div class="col-md-8 pay-ondelivery-text">
                        <h1>Pay on delivery</h1>
                    </div>
                    <div class="row col-md-8 pay-ondelivery-info">
                        <div class="col-md-5">
                            <h4>Pay directly in cash, credit card payment on delivery.</h4>
                            <h4>Customer pay all bill or pay the rest.</h4><br>
                            <h4>Examination of goods prior to delivery, Warranty certificate, instructions for use</h4>
                        </div>
                        <div class="col-md-5">
