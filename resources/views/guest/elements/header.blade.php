    ...
    <div class="khoa-header__info">
        <div class="container-md">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="#" class="text-decoration-none text-white"><i
                                    class="fa-solid fa-map-location-dot"></i> 590, CMT8, QUẬN 3, TP.HCM</a>
                        </div>
                        <div class="col-md-6">
                            <a href="#" class="text-decoration-none text-white"><i class="fa-solid fa-phone "></i>
                                0865 677 010</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <a href="#" class="text-decoration-none text-white float-right"> <i
